...
.brand-hit:hover{ filter: brightness(1.05); }
...
.visually-hidden{ position: absolute !important; opacity: 0; pointer-events: none; }

.visually-hidden:checked + .swatch { outline: 2px solid #111827; outline-offset: 2px; }
...
:global(html.theme-dark) .settings-card{ background: #1f2937; color: #e5e7eb; border-color: rgba(255,255,255,.06); }
:global(html.theme-dark) .settings-card__footer{ background: #111827; border-top-color: rgba(255,255,255,.06); }
:global(html.theme-dark) .settings-label{ color: #9ca3af; }
:global(html.theme-dark) .settings-pill{ background: #111827; border-color: #374151; color: #e5e7eb; }
:global(html.theme-dark) .settings-pill:hover{ background: #0b1220; }
:global(html.theme-dark) .visually-hidden:checked + .swatch{ outline: 2px solid #e5e7eb; outline-offset: 2px; }
