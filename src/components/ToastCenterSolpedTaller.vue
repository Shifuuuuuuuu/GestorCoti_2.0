<template>
  <div class="toast-container position-fixed end-0 p-3" style="z-index:1080; top: 39%;">
    <div
...
const safeToasts = computed(() =>
  toasts.items
    .filter(t => t.channel === 'solped_taller')
    .map(t => {
      let _to = null
      if (t.to) {
        try {
          ...
          console.error('[ToastCenterSolpedTaller] Ruta inválida:', e)
        }
      }
      return { ...t, _to }
    })
