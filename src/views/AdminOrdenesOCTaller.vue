      ...
      <div class="offcanvas-panel">
            ...
            <div class="col-12">
              ...
              <div class="small mt-1">
                ...
                <span v-else-if="!solpedsFiltradas.length" class="text-secondary"
                  >No hay SOLPEDs pendientes/parciales para mostrar.</span
                >
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="d-flex align-items-center justify-content-between mb-1">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  />
                  <button class="btn btn-secondary" @click="openArchivoOCEdit">
            ...
            <div class="col-12">
              <div class="d-flex align-items-center justify-content-between mb-1">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  />
                  <button class="btn btn-sm btn-outline-secondary" @click="openArchivosStorageEdit">
        ...
        <div class="offcanvas-footer">
          <div class="d-flex justify-content-end gap-2 flex-wrap">
            ...
            <button class="btn btn-primary" :disabled="guardando || guardandoSolped" @click="guardarEdicion">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="d-flex gap-2 flex-wrap align-items-center">
                ...
                />
                <button class="btn btn-secondary" @click="openArchivoOCNuevo">
                  <i class="bi bi-paperclip me-1"></i> Seleccionar archivo OC
                </button>
            ...
            <div class="col-12">
              ...
              <div class="d-flex gap-2 flex-wrap align-items-center">
                ...
                />
                <button class="btn btn-secondary" @click="openArchivosStorageNuevo">
...
@media (max-width: 576px){ .text-truncate { max-width: 180px; } }
