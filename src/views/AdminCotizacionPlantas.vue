      ...
      <section class="hero-card mb-4">
        ...
        <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap position-relative">
          <div>
            ...
            <h1 class="hero-title mb-1">Admin · Cotizaciones Plantas</h1>
            <p class="hero-subtitle mb-0">
              Administra cotizaciones de plantas, filtra por responsable o estatus, edita ítems, archivos e historial desde una vista más limpia y profesional.
            </p>
          </div>
              ...
              <tr v-else v-for="r in rows" :key="r.__id">
                ...
                <td>
                  <div class="provider-main min-w-0">
                    ...
                    <div class="min-w-0">
                      <div class="provider-name text-truncate">
            ...
            <article v-for="r in rows" :key="r.__id" class="oc-mobile-card">
              ...
              <div class="mobile-card-body">
                <div class="mobile-info-row">
                  ...
                  <span class="mobile-info-value text-truncate">
                    {{ r.nombre_centro_costo || r.centroCostoNombre || r.centroCosto || r.numero_contrato || '—' }}
                  </span>
                </div>
                <div class="mobile-info-row">
      ...
      <div class="offcanvas-panel offcanvas-panel-sm">
        <div class="offcanvas-header">
          <div>
            ...
            <div class="fw-bold fs-5"><i class="bi bi-funnel me-2"></i>Filtros · Cotizaciones Plantas</div>
          </div>
      ...
      <div class="offcanvas-panel editor-panel">
        <div class="offcanvas-header">
          <div>
            ...
            <div class="fw-bold fs-5 text-truncate">Editar cotización plantas</div>
          </div>
        ...
        <div class="offcanvas-body">
          <div class="form-block">
            <div class="row g-3">
              ...
              <div class="col-12 col-md-5">
                <label class="form-label">Fecha actualizado</label>
              ...
              <div class="col-12">
                ...
                <div class="d-block d-sm-none">
                  ...
                  <div class="list-group list-group-flush">
                    <div v-for="(it, idx) in edit.items" :key="'m-'+(it.__tempId || idx)" class="list-group-item mobile-item-card">
                ...
                <div class="section-head">
                  ...
                  <div class="d-flex gap-2 flex-wrap">
                    <input
                      ...
                      @change="onArchivoOC"
                    >
                    <button class="btn btn-sm btn-soft-secondary" @click="openArchivoOCPicker">
                      <i class="bi bi-paperclip me-1"></i> Reemplazar archivo
                    </button>
                  </div>
                </div>
                  ...
                  <div class="list-group-item" v-for="(f, idx) in edit.archivoOC" :key="'oc-'+idx">
                    <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                      ...
                      <div class="d-flex gap-2">
                        <a class="btn btn-sm btn-soft-secondary" :href="f?.url" target="_blank">Ver</a>
                        <button class="btn btn-sm btn-soft-danger" @click="borrarArchivoOC(idx)">
                          <i class="bi bi-trash3"></i>
                        </button>
                      </div>
                    </div>
              ...
              <div class="col-12">
                <div class="section-head">
                  ...
                  <div class="d-flex gap-2 flex-wrap">
                    ...
                    >
                    <button class="btn btn-sm btn-soft-secondary" @click="openArchivosStoragePicker">
      ...
      <div class="vmodal">
        <div class="vmodal-header">
          <div>
            ...
            <h5 class="mb-0 fw-bold">Nueva cotización plantas</h5>
          </div>
        </div>
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  >
                  <button class="btn btn-soft-secondary" @click="openArchivoOCNuevoPicker">
              ...
              <div class="col-12">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  >
                  <button class="btn btn-soft-secondary" @click="openArchivosStorageNuevoPicker">
        ...
        <div class="vmodal-body">
          ...
          <div class="confirm-box">
            ...
            <div class="confirm-row">
              ...
              <strong>{{ confirmRow?.nombre_centro_costo || confirmRow?.centroCostoNombre || confirmRow?.numero_contrato || '—' }}</strong>
            </div>
            <div class="confirm-row">
