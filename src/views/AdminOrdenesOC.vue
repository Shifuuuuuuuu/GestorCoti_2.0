      ...
      <section class="hero-card mb-4">
        ...
        <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap position-relative">
          <div>
            ...
            <h1 class="hero-title mb-1">Admin · Órdenes OC</h1>
            <p class="hero-subtitle mb-0">
              Administra órdenes de compra, filtra por responsable o estatus, edita ítems, archivos y asociaciones con SOLPED desde una vista más limpia y profesional.
            </p>
          </div>
      ...
      <div class="offcanvas-panel offcanvas-panel-sm">
        <div class="offcanvas-header">
          <div>
            ...
            <div class="fw-bold fs-5"><i class="bi bi-funnel me-2"></i>Filtros · Órdenes OC</div>
          </div>
      ...
      <div class="offcanvas-panel editor-panel">
        <div class="offcanvas-header">
          <div>
            ...
            <div class="fw-bold fs-5 text-truncate">Editar Orden OC</div>
          </div>
          ...
          <div class="form-block">
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <div class="form-text">
                  Se guardan automáticamente <strong>numero_solped</strong> y <strong>solpedId</strong>.
                </div>
                  ...
                  <div class="list-group-item" v-if="edit.archivoOC?.url">
                    <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap">
                      ...
                      <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-sm btn-soft-danger" @click="borrarArchivoOC">
                          <i class="bi bi-trash3"></i>
                        </button>
                      </div>
                    </div>
      ...
      <div class="vmodal">
        <div class="vmodal-header">
          <div>
            ...
            <h5 class="mb-0 fw-bold">Nueva Orden OC</h5>
          </div>
        </div>
